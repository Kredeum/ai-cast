...
import deploymentsJson from "@ai-cast/foundry/deployments.json";
...
export const contracts = deploymentsJson as GenericContractsDeclaration | null;

type ConfiguredChainId = (typeof scaffoldConfig)["targetNetworks"][0]["id"];

type IsContractDeclarationMissing<TYes, TNo> = typeof deploymentsJson extends {
  // disable eslint any
  [key in ConfiguredChainId]: number;
}
  ? TNo
  : TYes;
